...
//      Detalle.max(id_venta);
//      Producto.findOne(where: busqueda.pro)
...
//                        Producto.finOne({where:{id: item.id_producto}}).then(function(producto){
//                              var cant_actual= producto.cantidad;
//                              if(cant_actual<=0){
//                                  console.log("aqui hay que controlar y poner q no sea menos 0");
//                              }
//                            
//                        });
